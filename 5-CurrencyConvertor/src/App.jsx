...
function App() {
  ...
  const toCurrencyOptions = Object.keys(fromCurrency)
  ...
  return (
        <div
            ...
            style={{
                backgroundImage: `url('https://images.pexels.com/photos/7567529/pexels-photo-7567529.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')`,
            }}
        >
